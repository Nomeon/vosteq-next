...
const Deskundigen = () => {
  return (
    <div className="container flex flex-row gap-8 pb-16 pt-[28rem]">
      <div className="w-1/2 flex flex-col gap-8">
        ...
        <Image className='object-cover py-4' src="/images/systeem.svg" alt='Het systeem van Vosteq' height={80} width={370} />
        <h4 className="text-paars">Kennis en inspiratie</h4>
        <div className="flex text-donkergroen font-aptos text-base">
          <ul className="inline">
            <li className="inline-block py-1 hover:text-paars hover:font-semibold"><Link href='/'>Veranderen naar een nieuwe toekomstbestendige horizon {">"}</Link></li>
            <Separator />
            <li className="inline-block py-1 hover:text-paars hover:font-semibold"><Link href='/'>Nuchter kijken naar jouw bedrijf en ideeën vormen {">"}</Link></li>
            <Separator />
            <li className="inline-block py-1 hover:text-paars hover:font-semibold"><Link href='/'>Alleen bieden wat echt nodig is voor jouw bedrijf {">"}</Link></li>
          </ul>
        </div>
      </div>
      <div className="w-1/2">
