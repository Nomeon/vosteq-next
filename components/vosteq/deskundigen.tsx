...
const Deskundigen = () => {
  return (
    <div className="container flex flex-row gap-8 py-16">
      <div className="w-1/2 flex flex-col gap-8">
        ...
        <div className="flex text-donkergroen font-aptos text-base">
          <ul className="inline">
            <li className="inline-block py-1 hover:text-paars hover:font-semibold">Veranderen naar een nieuwe toekomstbestendige horizon {">"}</li>
            <Separator />
            <li className="inline-block py-1 hover:text-paars hover:font-semibold">Nuchter kijken naar jouw bedrijf en ideeën vormen {">"}</li>
            <Separator />
            <li className="inline-block py-1 hover:text-paars hover:font-semibold">Alleen bieden wat echt nodig is voor jouw bedrijf {">"}</li>
          </ul>
        </div>
      </div>
      <div className="w-1/2">
