        ...
        <div className="container pb-16 md:pb-32">
            <div className="grid md:grid-cols-4 grid-cols-1 gap-8 max-md:hidden">
                {shuffledItems.map((item, idx) => (
                    <div
                        key={idx}
                        className="basis-2/3 md:basis-1/4 flex flex-col relative"
                    >
                            ...
                            <div className="relative overflow-hidden">
                                ...
                                >
                                    <p
                                        ...
                                        } transition-all duration-300 text-wit text-base font-aktiv-grotesk-extended w-full p-4`}
                                    >
                                        {item.description}
                                    </p>
                                </div>
                        ...
                        <p className="px-4 py-2 text-donkerpaars font-aktiv-grotesk-extended font-semibold">
                            {item.name}
                        </p>
                    </div>
                ))}
                            ...
                            <div className="relative group">
                                <div className="relative overflow-hidden">
                                    ...
                                    <div className="w-full h-12 absolute bottom-0 flex flex-row justify-between items-center p-2 md:hidden">
                                        <p
                                            className={`text-white font-aptos transition-all duration-300" pl-2 ${
                                                visibleOverlays[idx]
                                                    ? "opacity-0"
                                                    : "opacity-100"
                                            }`}
