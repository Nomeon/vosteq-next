    ...
    <div className='flex flex-col'>
      ...
      <div className='container flex flex-col md:flex-row py-16'>
        <div className='md:w-1/2 flex flex-col gap-8 justify-center'>
          <h2 className='text-paars max-md:text-2xl'>Hoe gaan we te werk?</h2>
        ...
        <Accordion type='single' collapsible className='md:w-1/2'>
          <AccordionItem value='stap1'>
            <AccordionTrigger className='text-paars text-sm md:text-lg'><div className='flex'><p className='pr-2 font-bold'>Stap 1.</p>Inzicht krijgen in je bedrijf</div></AccordionTrigger>
          ...
          <AccordionItem value='stap2'>
            <AccordionTrigger className='text-paars text-sm md:text-lg'><div className='flex'><p className='pr-2 font-bold'>Stap 2.</p>Identificeren van kernkwaliteiten</div></AccordionTrigger>
            <AccordionContent className='md:text-base'>
          ...
          <AccordionItem value='stap3'>
            <AccordionTrigger className='text-paars text-sm md:text-lg'><div className='flex'><p className='pr-2 font-bold'>Stap 3.</p>Strategische versterking</div></AccordionTrigger>
            <AccordionContent className='md:text-base'>
          ...
          <AccordionItem value='stap4'>
            <AccordionTrigger className='text-paars text-sm md:text-lg'><div className='flex'><p className='pr-2 font-bold'>Stap 4.</p>Implementatie en begeleiding</div></AccordionTrigger>
            <AccordionContent className='md:text-base'>
      ...
      <div className='bg-[#F1F9F9]'>
        <div className='flex md:container flex-col md:flex-row gap-16 md:gap-32 items-center'>
          <div className='md:w-1/2 max-md:pt-16 max-md:container'>
          ...
          <div className='md:w-1/2 p-12 md:p-24 h-full bg-gradient-to-br from-paars to-groen from-30%'>
            <p className='pb-4 text-wit max-md:text-sm font-aktiv-grotesk-extended'>Wil je succesvolle groei en duurzame winstgevendheid voor jouw organisatie realiseren? Neem dan vandaag nog contact met ons op en ontdek hoe ons directieadvies jouw organisatie van binnenuit versterkt. </p>
