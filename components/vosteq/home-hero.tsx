...
const HomeHero = () => {
  return (
    <section className="w-full text-white bg-paars container relative flex flex-col items-center">
      <h1 className="pt-16 text-center">Meer uit mens en machine</h1>
      <p className="font-aktiv-grotesk text-lg text-center pt-16 w-2/3">Wij zijn Vosteq, experts in Smart Manufacturing. Met onze kennis en ervaring helpen we jouw bedrijf 
      ...
      <Image className='-mt-48 object-cover translate-y-1/2' src="/images/hero.png" alt='Hero' height={400} width={1100} />
      <div className="w-40 bg-geel p-6 flex flex-col gap-2 text-paars absolute right-0 top-1/2 group hover:bg-groen hover:text-wit transition-all duration-200">
