...
const VosteqCarousel = () => {
  ...
  return (
    <div className="container bg-[#F1F9F9] pt-8 pb-32">
      <div className="flex flex-row justify-between px-16 items-center pb-8">
      ...
      <Carousel setApi={setApi}>
        <CarouselContent>
          <CarouselItem key={1} className="w-full flex flex-row">
          ...
          <CarouselItem key={2} className="w-full flex flex-row">
            <div className="flex w-1/2">
              <Image className='object-cover' src="/images/2018-Vosteq-hapert.webp" alt='Vosteq bij Hapert' width={650} height={550} />
            </div>
            <div className="flex flex-col w-1/2 p-16">
