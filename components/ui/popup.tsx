...
const Popup = () => {
  ...
  return (
    <div>
      {isPopupVisible && (
        <Link href='/contact' className="z-30 fixed right-0 top-1/3 w-44 bg-geel p-6 flex flex-col gap-2 text-paars group hover:bg-groen hover:text-wit transition-all duration-200 max-md:hidden">
            ...
            <div className="font-aktiv-grotesk flex flex-row items-center">
