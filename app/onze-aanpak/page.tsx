...
export default function OnzeAanpak() {
  return (
    <div className="flex flex-col items-center w-full">
      <Popup />
      <div className="w-full h-96 max-md:container text-center flex flex-col items-center justify-center gap-16 bg-gradient-to-br from-paars to-groen from-60%">
      ...
      <div className="container flex flex-col md:flex-row gap-16 md:gap-32 md:py-16 md:pt-32 py-4">
        <div className="md:w-1/2 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 md:flex pt-8 gap-8">
            <div className="flex flex-col md:w-1/2 gap-4">
              <h3 className="text-paars">Inzicht</h3>
            ...
            <div className="flex flex-col md:w-1/2 gap-4">
              <h3 className="text-paars text-xl">Strategisch plan</h3>
