  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div className="w-full lg:h-96 max-lg:py-16 max-lg:container text-center flex flex-col items-center justify-center gap-16 bg-gradient-to-br from-paars to-groen from-60%">
        ...
        <p className="text-wit text-lg w-2/3 text-center lg:container">Wij zijn Vosteq: jouw partner in organisatieverbetering en procesoptimalisatie. Met onze kennis en ervaring helpen we jouw bedrijf naar een nieuwe toekomstbestendige horizon. Ontdek hoe we meer uit mens en machine halen.</p>
      </div>
      ...
      <div className="w-full flex items-center container justify-center pb-32">
        <ContactForm />
      </div>
      <div className='bg-gradient-to-b from-paars to-groen from-30% w-full'>
        <div className="container flex flex-col lg:flex-row items-center w-full">
          <div className="flex lg:w-1/2 flex-col h-full justify-center gap-4 lg:p-24 max-lg:py-16">
          ...
          <div className="lg:w-1/2 w-full h-full lg:p-16 max-lg:pb-16">
            <DynamicMapComponent />
          </div>
        </div>
      </div>
