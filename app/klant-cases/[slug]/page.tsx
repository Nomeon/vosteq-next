...
export default async function CasePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='container flex flex-col lg:flex-row gap-16 lg:gap-32 lg:pt-32'>
        <div className="flex gap-16 lg:gap-32 font-aptos text-base">
          <div className='w-1/2'>
          ...
          <div className='w-1/2'>
            <h3 className='pb-2 text-paars max-lg:pt-8'>Wat steek je hiervan op?</h3>
            <ul className='pt-4'>
